...
{		
	public class TimeBombAction : ActionGame 
	{
	...
	#region Init
		...
		{
			TypeAction = GameActionType.TIME_BOMB;
		...
		{
			if (СountCompletedLevels >= data.bombMaxCompletedLevels)
			{
		...
		{		
			...
			СountCompletedLevels = data.bombStartValue;
		}
